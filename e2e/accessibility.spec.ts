...
test.describe('Accessibility Testing', () => {
  ...
  test.describe('WCAG 2.2 AA Compliance', () => {
    test('should pass axe accessibility audit on homepage', async ({
      page,
    }) => {
    ...
    test('should pass axe accessibility audit on document pages', async ({
      page,
    }) => {
    ...
    test('should pass axe accessibility audit on form pages', async ({
      page,
    }) => {
    ...
    test('should pass axe accessibility audit on dashboard', async ({
      page,
    }) => {
  ...
  test.describe('Keyboard Navigation', () => {
    ...
    test('should handle dropdown menus with keyboard', async ({ page }) => {
      ...
      const megaMenuTrigger = page
        .getByRole('button', { name: /create|documents/i })
        .first();
      if (await megaMenuTrigger.isVisible()) {
        ...
        await page.waitForSelector(
          '[role="menu"], [data-testid*="mega-menu"]',
          { timeout: 5000 },
        );
  ...
  test.describe('ARIA Attributes', () => {
    ...
    test('should have proper aria-invalid for form errors', async ({
      page,
    }) => {
      await page.goto('/documents/bill-of-sale');
        ...
        for (let i = 0; i < 10; i++) {
          ...
          if (await focused.isVisible()) {
            const id =
              ...
              (await focused.evaluate((el) => el.tagName));
