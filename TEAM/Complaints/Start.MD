...
Flow:
1. Load AGENTS.md to align with global automation rules, then review REMEMBER.md and ops/Memory.md as read-only context to understand active initiatives and recent incidents.
