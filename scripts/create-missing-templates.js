...
documentDirs.forEach((dir) => {
  ...
  if (!hasEnTemplate) {
    ...
    console.log(`✅ Created EN template: ${dir}.md`);
    created = true;
  }
  ...
  if (!hasEsTemplate) {
    ...
    console.log(`✅ Created ES template: ${dir}.md`);
    created = true;
  }
...
console.log(`   ✅ Documents with new templates: ${createdCount}`);
console.log(`   ⏭️  Documents already complete: ${skippedCount}`);
