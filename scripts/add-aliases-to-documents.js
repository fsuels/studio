...
const documentAliases = {
  ...
  'divorce-settlement-agreement': {
    ...
    es: [
      'acuerdo de divorcio',
      'liquidación de divorcio',
      'acuerdo matrimonial',
      'acuerdo de separación',
      'términos de divorcio',
    ],
  },
...
const documentDirs = fs.readdirSync(usDocsDir).filter((item) => {
