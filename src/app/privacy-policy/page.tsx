    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-4 text-muted-foreground">
        ...
        <ul className="list-disc list-inside ml-4">
          ...
          <li>
            <strong>Document Data:</strong> Information you provide when generating
            documents, including details about your situation, names, addresses,
            and other relevant data points required for the document.
          </li>
        </ul>
        ...
        <h2 className="text-xl font-semibold text-foreground pt-4">Disclosure of Your Information</h2>
         ...
         <ul className="list-disc list-inside ml-4">
            <li>
             ...
             <li>
                <strong>Third-Party Service Providers:</strong> We may share your information with third parties that perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and marketing assistance. This includes sharing necessary data with AI service providers (like Google Generative AI) solely for the purpose of providing core Service features like document type inference and potentially document content generation/review, under strict confidentiality agreements.
            </li>
             <li>
        ...
        <h2 className="text-xl font-semibold text-foreground pt-4">Security of Your Information</h2>
        <p>
         ...
         <h2 className="text-xl font-semibold text-foreground pt-4">Policy for Children</h2>
         <p>
