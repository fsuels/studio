    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-4 text-muted-foreground">
        ...
        <p>
          ...
          Service&quot;) carefully before using the 123LegalDoc website and
          services (the &quot;Service&quot;) operated by [Your Company Name]
          (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).
        </p>
        ...
        <p>
          ...
          potential legal document needs and guiding them through a
          questionnaire to gather information for document generation. The
          Service includes features for voice input transcription, real-time
          editing, PDF preview, and digital signing (where applicable).
        </p>
        <p>
          ...
          provide accurate and complete information when prompted by the
          Service&apos;s questionnaires.
        </p>
        ...
        <p>
          ...
          guarantee the accuracy, suitability, or completeness of any
          information or documents generated through the Service.
        </p>
        <p>
          You are solely responsible for reviewing and verifying the accuracy
          and appropriateness of any document generated using the Service before
          signing or using it.
        </p>
        ...
        <p>
          <strong>
            123LegalDoc is not a law firm and does not provide legal advice.
          </strong>
          ...
          for advice from a qualified legal professional. You should consult
          with a licensed attorney for advice regarding your specific legal
          situation.
        </p>
        ...
        <p>
          ...
          property of [Your Company Name] and its licensors. The documents you
          generate using your own information are your property, but the
          underlying templates and software remain ours.
        </p>
        ...
        <p>
          ...
          course of performance. We do not warrant that the Service will
          function uninterrupted, secure or available at any particular time or
        ...
        <p>
          ...
          posting the new Terms of Service on this page. By continuing to access
          or use our Service after any revisions become effective, you agree to
