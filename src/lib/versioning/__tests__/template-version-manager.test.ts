...
describe('TemplateVersionManager', () => {
  ...
  describe('createVersion', () => {
    ...
    it('should reject duplicate versions', async () => {
      ...
      ).rejects.toThrow('Version 1.0.0 already exists for template test-template');
    });
  });
  ...
  describe('deprecateVersion', () => {
    it('should deprecate a version', async () => {
      ...
      await manager.deprecateVersion('test-template', '1.0.0', 'Security vulnerability');
  ...
  describe('validateCompatibility', () => {
    ...
    it('should validate version increment', async () => {
      ...
      const versionIncrementResult = results.find(r => r.rule === 'version-increment');
    ...
    it('should detect breaking changes requiring major version bump', async () => {
      ...
      const breakingChangesResult = results.find(r => r.rule === 'breaking-changes');
  ...
  describe('compareVersions', () => {
    it('should generate version diff', async () => {
      ...
      const result = await manager.compareVersions('test-template', '1.0.0', '1.1.0');
