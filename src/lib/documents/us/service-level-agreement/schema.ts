...
export const ServiceLevelAgreementSchema = z.object({
  ...
  serviceProviderAddress: z
    .string()
    .min(1, 'Service provider address is required'),
  ...
  // Responsibilities
  providerResponsibilities: z
    .string()
    .min(1, 'Provider responsibilities are required'),
  clientResponsibilities: z
    .string()
    .min(1, 'Client responsibilities are required'),
