...
export const BrandAmbassadorAgreementSchema = z.object({
  ...
  ambassadorLevel: z.enum(['bronze', 'silver', 'gold', 'platinum', 'custom']).default('bronze'),
  ...
  compensationType: z.enum(['monthly-stipend', 'product-only', 'commission', 'tiered', 'hybrid']).default('product-only'),
  ...
  reviewFrequency: z.enum(['monthly', 'quarterly', 'bi-annually']).default('quarterly'),
  ...
  contentOwnership: z.enum(['ambassador', 'brand', 'shared']).default('ambassador'),
  ...
  communicationMethod: z.enum(['email', 'phone', 'slack', 'app']).default('email'),
