...
export const affidavitOfDeathMeta: Omit<LegalDocument, 'schema' | 'questions'> = {
  ...
  translations: {
    en: {
      ...
      description: 'Legal document certifying the death of a person when a death certificate is unavailable or as additional proof of death.',
      aliases: [
        'death affidavit',
    ...
    es: {
      ...
      description: 'Documento legal que certifica la muerte de una persona cuando no está disponible un certificado de defunción o como prueba adicional de muerte.',
      aliases: [
