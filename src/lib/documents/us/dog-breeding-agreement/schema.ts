...
export const DogBreedingAgreementSchema = z.object({
  ...
  // Breeding Terms
  breedingMethod: z
    .enum(['natural', 'artificial-insemination', 'either'])
    .default('natural'),
  ...
  paymentTerms: z
    .enum(['upfront', 'on-confirmation', 'on-whelping', 'pick-of-litter'])
    .default('upfront'),
  ...
  registrationResponsibility: z
    .enum(['stud-owner', 'bitch-owner', 'shared'])
    .default('bitch-owner'),
