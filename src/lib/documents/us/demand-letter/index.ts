...
export const demandLetter: LegalDocument = {
  ...
  translations: {
    ...
    es: {
      ...
      description:
        'Crea un Demand Carta for Payment legalmente válido con nuestra plantilla fácil de usar. Incluye requisitos específicos del estado.',
      aliases: [],
    },
  },
};
