...
export const ConsultingAgreementSchema = z.object({
  ...
  consultingType: z.enum(['strategic', 'technical', 'marketing', 'financial', 'hr', 'legal', 'other']),
  ...
  timeCommitment: z.enum(['full-time', 'part-time', 'as-needed', 'project-based']),
  ...
  // Compensation
  compensationType: z.enum(['hourly', 'daily', 'monthly', 'project-fee', 'retainer']),
  hourlyRate: z.number().optional(),
  projectFee: z.number().optional(),
  retainerAmount: z.number().optional(),
  paymentSchedule: z.enum(['weekly', 'bi-weekly', 'monthly', 'upon-completion', 'milestone-based']),
