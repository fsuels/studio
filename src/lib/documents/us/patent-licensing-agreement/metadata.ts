...
export const patentLicensingAgreementMeta: LegalDocument = {
  ...
  translations: {
    en: {
      ...
      description: 'Agreement for licensing patent rights and intellectual property usage.',
      aliases: ['patent license', 'ip licensing agreement', 'technology licensing contract'],
    },
    es: {
      name: 'Acuerdo de Licencia de Patente',
      description: 'Acuerdo para licenciar derechos de patente y uso de propiedad intelectual.',
