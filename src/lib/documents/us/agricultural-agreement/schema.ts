...
export const AgriculturalAgreementSchema = z.object({
  ...
  // Agreement Type
  agreementType: z.enum(['cash-rent', 'crop-share', 'livestock-share', 'custom-farming', 'grazing']).default('cash-rent'),
  ...
  paymentSchedule: z.enum(['annual', 'semi-annual', 'quarterly', 'monthly']).optional(),
