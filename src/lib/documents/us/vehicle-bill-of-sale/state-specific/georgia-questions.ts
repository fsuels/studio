...
// Georgia-specific questions for T-7 Bill of Sale
export const georgiaVehicleBillOfSaleQuestions: Question[] = [
  // Vehicle Information
  {
    id: 'vehicle_year',
    label: 'Vehicle Year',
  ...
  // Notarization (Required in Georgia)
  {
    id: 'notary_acknowledgment',
    label: 'Notarization Required in Georgia',
    type: 'boolean',
    required: true
  }
];
...
export const georgiaFieldMapping = {
  // These would need to be mapped based on actual T-7 form fields
  'Year': 'vehicle_year',
  'Make': 'vehicle_make',
  'Model': 'vehicle_model',
  'VIN': 'vehicle_vin',
