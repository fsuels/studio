...
export const PersonalCareAgreementSchema = z.object({
  ...
  smokingPolicy: z
    .enum(['prohibited', 'designated-areas', 'allowed'])
    .default('prohibited'),
  alcoholPolicy: z
    .enum(['prohibited', 'off-duty-only', 'allowed'])
    .default('prohibited'),
  visitorRestrictions: z.string().optional(),
  personalPhoneUse: z
    .enum(['prohibited', 'limited', 'emergency-only', 'allowed'])
    .default('limited'),

  // Supplies and Equipment
  suppliesProvision: z
    .enum(['caregiver-provides', 'recipient-provides', 'shared'])
    .default('recipient-provides'),
  equipmentProvision: z
    .enum(['caregiver-provides', 'recipient-provides', 'shared'])
    .default('recipient-provides'),
