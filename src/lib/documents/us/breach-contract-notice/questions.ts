...
export const breachContractNoticeQuestions: DocumentQuestion[] = [
  ...
  // Breach Details
  {
    ...
    options: [
      ...
      { value: 'defective_performance', label: 'Defective or substandard performance' },
      { value: 'delay_in_performance', label: 'Delay in performance' },
      { value: 'failure_to_provide_services', label: 'Failure to provide services' },
      { value: 'breach_of_warranty', label: 'Breach of warranty' },
      { value: 'violation_of_terms', label: 'Violation of contract terms' },
      { value: 'anticipatory_breach', label: 'Anticipatory breach (announced they won\'t perform)' },
  ...
  },
  {
    ...
    type: 'textarea',
    required: true,
    placeholder: 'Provide a comprehensive description of how the other party has breached the contract. Include specific facts, dates, and contract provisions violated...',
    minLength: 100
  },
  {
  ...
  },
  {
    ...
    type: 'text',
    required: true,
    placeholder: 'Payment was due 30 days after invoice but has not been received after 60 days'
  },
  {
  ...
  },
  {
    ...
    type: 'boolean',
    required: true,
    helpText: 'A material breach goes to the essence of the contract and may justify termination'
  },
  ...
  },
  {
    ...
    type: 'date',
    required: false,
    conditionalOn: { field: 'breachDetails.priorNotifications.previousNoticeGiven', value: true }
  },
  ...
  },
  {
    ...
    type: 'textarea',
    required: false,
    placeholder: 'Describe exactly what you want them to do to cure the breach...',
    conditionalOn: { field: 'remedies.specificPerformance.demanded', value: true }
  },
  {
  ...
  // Cure Period
  {
    ...
    type: 'boolean',
    required: true,
    helpText: 'Allowing them time to fix the problem before taking further action'
  },
  {
  ...
  },
  {
    ...
    conditionalOn: { field: 'consequences.legalAction.threatened', value: true }
  },
  {
  ...
  // Future Relationship
  {
    ...
    type: 'boolean',
    required: true,
    helpText: 'If the breach is cured, do you want to continue with the contract?'
  },
  {
