// src/lib/documents/us/music-license-agreement/schema.ts
import { z } from 'zod';

export const MusiclicenseagreementSchema = z.object({
...
export type MusiclicenseagreementData = z.infer<typeof MusiclicenseagreementSchema>;
