...
export const StatementOfWorkSchema = z.object({
  ...
  paymentSchedule: z
    .enum(['milestone-based', 'monthly', 'completion', 'time-and-materials'])
    .optional(),
  ...
  contractorResponsibilities: z
    .string()
    .min(1, 'Contractor responsibilities are required'),
  ...
  ipOwnership: z
    .enum(['client', 'contractor', 'shared', 'retained'])
    .optional(),
