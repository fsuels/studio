...
export const DigitalAssetAgreementSchema = z.object({
  ...
  party1Type: z
    .enum(['individual', 'entity', 'dao', 'trust'])
    .default('individual'),
  ...
  tokenStandard: z
    .enum(['erc-20', 'erc-721', 'erc-1155', 'bep-20', 'spl', 'other'])
    .optional(),
  ...
  custodyArrangement: z
    .enum(['self-custody', 'third-party', 'multi-party', 'institutional'])
  ...
  // Dispute Resolution
  disputeResolution: z
    .enum(['arbitration', 'mediation', 'blockchain-based', 'traditional-court'])
    .default('arbitration'),
