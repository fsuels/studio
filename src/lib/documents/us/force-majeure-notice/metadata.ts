...
export const forceMajeureNoticeMetadata: DocumentMetadata = {
  ...
  description: 'Create a formal notice to invoke force majeure provisions due to unforeseeable circumstances beyond your control.',
  ...
  tags: ['force majeure', 'contract excuse', 'unforeseeable circumstances', 'contract performance', 'legal notice'],
  difficulty: 'advanced',
  ...
  faqs: [
    {
      ...
      answer: 'Force majeure events are typically unforeseeable circumstances beyond your control, such as natural disasters, wars, pandemics, government actions, or acts of God. The specific events are usually defined in your contract.'
    },
    {
      question: 'Do I need a force majeure clause in my contract?',
      answer: 'Yes, most force majeure protections require a specific clause in your contract. Without such a clause, you may need to rely on other legal doctrines like impossibility or frustration of purpose.'
    },
    {
      question: 'How quickly must I give notice?',
      answer: 'Force majeure clauses typically require prompt notice, often within a specific timeframe (e.g., 30 days). Check your contract for specific notice requirements and deadlines.'
    }
  ],
  relatedDocuments: ['breach-contract-notice', 'service-agreement', 'commercial-lease-agreement'],
  seoMetadata: {
    metaTitle: 'Force Majeure Notice Template | Contract Performance Excuse',
    metaDescription: 'Create professional force majeure notices for unforeseeable circumstances. Protect against breach claims during emergencies and disasters.',
    keywords: ['force majeure notice', 'contract excuse', 'unforeseeable circumstances', 'act of god', 'contract performance']
  },
