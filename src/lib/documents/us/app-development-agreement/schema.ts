...
export const AppDevelopmentAgreementSchema = z.object({
  ...
  appType: z.enum(['mobile-ios', 'mobile-android', 'mobile-cross-platform', 'web-app', 'progressive-web-app']).default('mobile-cross-platform'),
  ...
  // Design Requirements
  designProvided: z.enum(['client', 'developer', 'collaborative']).default('developer'),
  ...
  paymentStructure: z.enum(['fixed-price', 'hourly', 'milestone-based', 'retainer']).default('milestone-based'),
  ...
  supportLevel: z.enum(['basic', 'standard', 'premium', 'none']).default('basic'),
