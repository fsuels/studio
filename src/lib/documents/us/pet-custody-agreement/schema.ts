...
export const PetCustodyAgreementSchema = z.object({
  ...
  petType: z.enum(['dog', 'cat', 'bird', 'fish', 'reptile', 'small-mammal', 'horse', 'other']),
  petBreed: z.string().optional(),
  petAge: z.string().optional(),
  petGender: z.enum(['male', 'female', 'neutered-male', 'spayed-female']).optional(),
  ...
  additionalPets: z.array(z.object({
    name: z.string(),
    type: z.string(),
  ...
  // Custody Arrangement
  custodyType: z.enum(['sole-custody', 'joint-custody', 'alternating-custody', 'visitation-schedule']),
  ...
  transportationResponsibility: z.enum(['party-a', 'party-b', 'alternating', 'mutual']).optional(),
  ...
  medicalDecisionMaking: z.enum(['party-a', 'party-b', 'joint', 'primary-custodian']),
  ...
  // Communication
  communicationMethod: z.enum(['phone', 'email', 'text', 'app', 'written']).optional(),
  ...
  petRelinquishment: z.enum(['mutual-consent', 'court-decision', 'specified-conditions']).optional(),
  ...
  offspringOwnership: z.enum(['party-a', 'party-b', 'shared', 'breeder']).optional(),
  
  // Training and Behavior
  trainingRequirements: z.string().optional(),
  behaviorStandards: z.string().optional(),
  trainingCosts: z.enum(['party-a', 'party-b', 'shared', 'custodian-pays']).optional(),
