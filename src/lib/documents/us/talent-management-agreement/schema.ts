...
export const TalentManagementAgreementSchema = z.object({
  ...
  talentType: z.enum(['musician', 'actor', 'comedian', 'athlete', 'influencer', 'model', 'writer']).optional(),
  ...
  territoryScope: z.enum(['worldwide', 'north-america', 'domestic', 'regional']).default('worldwide'),
  ...
  // Creative Control
  artisticControl: z.enum(['talent', 'manager', 'shared', 'consultation']).default('talent'),
  projectApproval: z.boolean().default(false),
  brandingDecisions: z.enum(['talent', 'manager', 'shared', 'consultation']).default('shared'),
  ...
  reportingFrequency: z.enum(['weekly', 'monthly', 'quarterly', 'as-needed']).default('monthly'),
