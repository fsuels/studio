...
export const SettlementAgreementSchema = z.object({
  ...
  paymentStructure: z
    .enum(['lump-sum', 'installments', 'performance-based', 'non-monetary'])
    .default('lump-sum'),
  ...
  disputeResolutionMethod: z
    .enum(['litigation', 'arbitration', 'mediation', 'negotiation'])
    .optional(),
  ...
  modificationRequirements: z
    .enum(['written-only', 'mutual-consent', 'specific-process'])
