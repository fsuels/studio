...
export const MemorandumOfUnderstandingSchema = z.object({
  ...
  party1Type: z.enum(['individual', 'corporation', 'llc', 'partnership', 'government', 'nonprofit']),
  ...
  party2Type: z.enum(['individual', 'corporation', 'llc', 'partnership', 'government', 'nonprofit']),
  ...
  party1Responsibilities: z.string().min(1, 'First party responsibilities are required'),
  party2Responsibilities: z.string().min(1, 'Second party responsibilities are required'),
