...
export const billOfSaleVehicle: LegalDocument = {
  ...
  questions: [
    { id: 'seller_info', label: 'documents.us.bill-of-sale-vehicle.seller_info.label', type: 'group', fields: ['seller_name', 'seller_phone', 'seller_address', 'seller2_name', 'seller2_phone'] },
    { id: 'buyer_info', label: 'documents.us.bill-of-sale-vehicle.buyer_info.label', type: 'group', fields: ['buyer_name', 'buyer_phone', 'buyer_address', 'buyer2_name', 'buyer2_phone'] },
