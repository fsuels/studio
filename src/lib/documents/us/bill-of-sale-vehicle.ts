...
export const billOfSaleVehicle: LegalDocument = {
  ...
  questions: [
    ...
    { id: 'add_seller2', label: 'documents.us.bill-of-sale-vehicle.add_seller2.label', type: 'boolean', required: false, tooltip: 'documents.us.bill-of-sale-vehicle.add_seller2.tooltip' },
    ...
    { id: 'add_buyer2', label: 'documents.us.bill-of-sale-vehicle.add_buyer2.label', type: 'boolean', required: false, tooltip: 'documents.us.bill-of-sale-vehicle.add_buyer2.tooltip' },
