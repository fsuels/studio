...
export const TrademarkLicenseAgreementSchema = z.object({
  ...
  licenseScope: z.enum(['full-rights', 'limited-use', 'specific-products', 'specific-services']),
  
  // Territory
  territoryScope: z.enum(['worldwide', 'united-states', 'specific-states', 'specific-countries', 'specific-regions']),
  ...
  royaltyType: z.enum(['percentage', 'flat-fee', 'minimum-guarantee', 'tiered']).optional(),
