...
export const FoodTruckAgreementSchema = z.object({
  ...
  locationOwnerType: z.enum(['private', 'municipal', 'commercial', 'event']).optional(),
  ...
  foodType: z.enum(['american', 'mexican', 'asian', 'mediterranean', 'bbq', 'desserts', 'mixed']).optional(),
  ...
  paymentSchedule: z.enum(['daily', 'weekly', 'monthly', 'per-event']).default('daily'),
  ...
  electricalConnection: z.enum(['self-sufficient', 'provided', 'hookup-available']).default('self-sufficient'),
  waterSupply: z.enum(['self-sufficient', 'provided', 'hookup-available']).default('self-sufficient'),
  sewerConnection: z.enum(['self-sufficient', 'provided', 'hookup-available']).default('self-sufficient'),
