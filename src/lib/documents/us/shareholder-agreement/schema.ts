...
export const shareholderAgreementSchema = z.object({
  ...
  boardOfDirectors: z.object({
    ...
    electionMethod: z.enum(['majority', 'cumulative', 'class-based']).default('majority'),
  ...
  buySellProvisions: z.object({
    ...
    valuationMethod: z.enum(['appraisal', 'formula', 'multiple-of-earnings']).default('appraisal'),
  ...
  terminationEvents: z.array(z.string()).default([
