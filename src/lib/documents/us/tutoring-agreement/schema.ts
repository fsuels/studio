...
export const TutoringAgreementSchema = z.object({
  ...
  // Session Details
  sessionLocation: z.enum(['tutor-home', 'student-home', 'library', 'online', 'other']).default('student-home'),
  sessionDuration: z.string().optional(),
  sessionFrequency: z.enum(['daily', 'weekly', 'bi-weekly', 'as-needed']).default('weekly'),
  ...
  paymentSchedule: z.enum(['per-session', 'weekly', 'monthly', 'package']).default('per-session'),
  paymentMethod: z.enum(['cash', 'check', 'electronic', 'other']).default('cash'),
  ...
  communicationFrequency: z.enum(['after-each-session', 'weekly', 'monthly', 'as-needed']).default('weekly'),
  communicationMethod: z.enum(['email', 'phone', 'text', 'in-person']).default('email'),
  ...
  disputeResolution: z.enum(['discussion', 'mediation', 'arbitration', 'court']).default('discussion'),
