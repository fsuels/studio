...
export const endorsementAgreementSchema = z.object({
  ...
  productService: z.string().min(1, 'Product or service being endorsed is required'),
  brandName: z.string().min(1, 'Brand name is required'),
  
  // Endorsement Details
  endorsementType: z.array(z.enum([
    'social-media',
    'television',
    'print',
    'radio',
  ...
  // Compensation
  compensationType: z.enum(['fixed-fee', 'per-post', 'commission', 'product-only', 'hybrid']),
