...
export const CreditCardAgreementSchema = z.object({
  ...
  employmentStatus: z.enum(['employed', 'self-employed', 'retired', 'unemployed', 'student']).optional(),
  annualIncome: z.string().optional(),
  
  // Card Information
  cardType: z.enum(['visa', 'mastercard', 'amex', 'discover', 'other']).default('visa'),
  ...
  paymentDueDate: z.enum(['15th', '20th', '25th', '30th', 'end-of-month']).default('25th'),
  ...
  creditHistory: z.enum(['excellent', 'good', 'fair', 'poor', 'no-credit']).optional(),
