...
export const TalentAgreementSchema = z.object({
  ...
  projectType: z.enum(['film', 'television', 'commercial', 'music', 'theater', 'digital']).default('film'),
  projectDescription: z.string().optional(),
  productionCompany: z.string().optional(),
  roleDescription: z.string().optional(),
  
  // Performance Details
  performanceType: z.enum(['acting', 'singing', 'dancing', 'modeling', 'voice-over', 'hosting']).default('acting'),
  ...
  // Compensation
  compensationType: z.enum(['flat-fee', 'daily-rate', 'hourly', 'residuals', 'percentage']).default('flat-fee'),
  ...
  // Payment Schedule
  paymentSchedule: z.enum(['upfront', 'completion', 'installments', 'per-day']).default('completion'),
  ...
  copyrightOwnership: z.enum(['company', 'talent', 'shared']).default('company'),
