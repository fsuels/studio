...
export const AthleticScholarshipAgreementSchema = z.object({
  ...
  skillLevel: z
    .enum(['division-i', 'division-ii', 'division-iii', 'naia', 'juco'])
    .optional(),
  conference: z.string().optional(),

  // Scholarship Details
  scholarshipType: z
    .enum(['full-ride', 'partial', 'head-count', 'equivalency'])
    .optional(),
  ...
  scholarshipDuration: z
    .enum(['one-year', 'multi-year', 'four-year', 'five-year'])
    .default('one-year'),
  ...
  disputeResolution: z
    .enum(['mediation', 'arbitration', 'university-process'])
    .default('university-process'),
