...
export const ProductLiabilityWaiverSchema = z.object({
  ...
  companyType: z.enum(['manufacturer', 'retailer', 'distributor', 'wholesaler']).default('manufacturer'),
  ...
  // Waiver Scope
  waiverScope: z.enum(['manufacturing-defects', 'design-defects', 'warning-defects', 'all-defects']).default('all-defects'),
  ...
  damageLimitation: z.enum(['purchase-price', 'repair-cost', 'replacement-cost', 'specific-amount']).optional(),
  ...
  // Product Categories
  productType: z.enum(['consumer-goods', 'industrial-equipment', 'medical-device', 'automotive', 'electronics', 'food-beverage', 'pharmaceutical', 'cosmetic', 'toy', 'sporting-goods', 'tools', 'appliance', 'furniture', 'other']).default('consumer-goods'),
