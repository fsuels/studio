...
export const schema = z.object({
  ...
  // Bonus Structure
  bonusType: z.enum(['Individual performance', 'Team performance', 'Company performance', 'Combined']),
  ...
  targetBonusPercentage: z.string().min(1, 'Target bonus percentage is required'),
  maximumBonusPercentage: z.string().min(1, 'Maximum bonus percentage is required'),
