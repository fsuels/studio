...
export const TimberSaleAgreementSchema = z.object({
  ...
  volumeUnit: z
    .enum(['board-feet', 'cords', 'tons', 'cubic-feet'])
    .default('board-feet'),
  ...
  paymentSchedule: z
    .enum(['upfront', 'installments', 'upon-delivery', 'completion'])
  ...
  // Harvesting Methods
  harvestingMethod: z
    .enum(['selective-cutting', 'clear-cutting', 'shelterwood', 'seed-tree'])
    .optional(),
  ...
  scalingMethod: z
    .enum(['log-scale', 'weight-scale', 'load-count'])
    .default('log-scale'),
