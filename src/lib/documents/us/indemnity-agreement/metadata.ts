...
export const indemnityAgreementMetadata: DocumentMetadata = {
  ...
  description: 'Create a legally binding agreement where one party agrees to compensate another for specified losses, damages, or liabilities.',
  ...
  tags: ['indemnification', 'liability protection', 'compensation agreement', 'risk transfer', 'financial protection'],
  difficulty: 'advanced',
  ...
  faqs: [
    {
      ...
      answer: 'Indemnity requires one party to compensate for losses, while hold harmless prevents liability claims. Many agreements combine both for comprehensive protection.'
    },
    {
      question: 'Can indemnity agreements cover future unknown risks?',
      answer: 'Yes, broad indemnity agreements can cover unknown future risks, but courts may limit enforcement if the language is too vague or unconscionable.'
    },
    {
      question: 'Are there limits to indemnification?',
      answer: 'Yes, indemnification typically cannot cover intentional wrongdoing, criminal acts, or gross negligence. Some states also limit indemnity for sole negligence.'
    }
  ],
  relatedDocuments: ['hold-harmless-agreement', 'liability-waiver', 'service-agreement'],
  seoMetadata: {
    metaTitle: 'Indemnity Agreement Template | Legal Indemnification Form',
    metaDescription: 'Create a professional indemnity agreement to protect against financial losses. Comprehensive template with customizable terms. Download instantly.',
    keywords: ['indemnity agreement', 'indemnification form', 'liability compensation', 'risk transfer agreement', 'financial protection']
  },
