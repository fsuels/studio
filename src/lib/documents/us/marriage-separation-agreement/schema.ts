...
export const MarriageSeparationAgreementSchema = z.object({
  ...
  childSupportFrequency: z.enum(['weekly', 'bi-weekly', 'monthly']).default('monthly'),
  ...
  healthInsuranceCosts: z.enum(['shared', 'spouse1', 'spouse2']).default('shared'),
  ...
  debtResponsibility: z.enum(['shared', 'separate', 'proportional']).default('separate'),
  ...
  childEducationCosts: z.enum(['shared', 'spouse1', 'spouse2']).default('shared'),
  extracurricularActivities: z.enum(['shared', 'spouse1', 'spouse2']).default('shared'),
  collegeExpenses: z.enum(['shared', 'spouse1', 'spouse2', 'not-covered']).default('shared'),
