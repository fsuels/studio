...
export const CourtFilingDocumentSchema = z.object({
  ...
  caseType: z.enum(['civil', 'criminal', 'family', 'probate', 'small-claims']).default('civil'),
  ...
  // Document Details
  documentType: z.enum(['complaint', 'answer', 'motion', 'petition', 'response', 'brief']).default('complaint'),
  ...
  // Service Information
  serviceMethod: z.enum(['personal', 'certified-mail', 'publication', 'electronic']).optional(),
