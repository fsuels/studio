...
export const liabilityWaiverMetadata: DocumentMetadata = {
  ...
  description: 'Create a comprehensive liability waiver to protect your business from legal claims related to injuries, damages, or losses.',
  ...
  tags: ['waiver', 'release form', 'liability protection', 'risk management', 'legal protection'],
  ...
  faqs: [
    {
      ...
      answer: 'Yes, when properly written and signed, liability waivers are generally enforceable. However, they cannot protect against gross negligence, intentional harm, or violations of law.'
    },
    {
      question: 'Can minors sign liability waivers?',
      answer: 'Minors cannot legally sign binding contracts. A parent or legal guardian must sign on their behalf, though some states may still allow the minor to pursue claims.'
    },
    {
      question: 'What activities require liability waivers?',
      answer: 'Any activity with inherent risks should use waivers, including sports, fitness activities, adventure tourism, workshops with equipment, and events where injuries could occur.'
    }
  ],
  relatedDocuments: ['hold-harmless-agreement', 'indemnity-agreement', 'incident-report'],
  seoMetadata: {
    metaTitle: 'Liability Waiver Form | Free Template & Legal Release',
    metaDescription: 'Create a professional liability waiver to protect your business. Comprehensive release form with assumption of risk clauses. Download instantly.',
    keywords: ['liability waiver', 'release form', 'waiver template', 'legal release', 'risk waiver']
  },
