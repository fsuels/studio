...
export const holdHarmlessAgreementSchema = z.object({
  ...
  activityDescription: z.string().min(50, 'Please provide a detailed description (at least 50 characters)'),
  ...
  // Specific Risks
  specificRisks: z.array(z.string()).min(1, 'Please identify at least one specific risk'),
