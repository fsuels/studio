...
export const CryptocurrencyAgreementSchema = z.object({
  ...
  // Transaction Details
  transactionType: z
    .enum(['sale', 'purchase', 'exchange', 'loan', 'mining', 'staking'])
    .default('sale'),
  ...
  // Payment Terms
  paymentMethod: z
    .enum(['cryptocurrency', 'fiat', 'both'])
    .default('cryptocurrency'),
  paymentCurrency: z.string().optional(),
  paymentSchedule: z
    .enum(['immediate', 'installments', 'milestone-based'])
    .default('immediate'),
  ...
  privateKeyResponsibility: z
    .enum(['party1', 'party2', 'shared'])
    .default('party1'),
  ...
  custodyArrangement: z
    .enum(['self-custody', 'third-party', 'shared'])
    .default('self-custody'),
  storageMethod: z
    .enum(['hot-wallet', 'cold-wallet', 'hardware', 'exchange'])
    .default('hot-wallet'),
