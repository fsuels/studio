...
export const schema = z.object({
  ...
  violationType: z.enum(['Attendance', 'Performance', 'Conduct', 'Policy Violation', 'Safety', 'Other']),
  ...
  // Corrective Action
  correctiveActionRequired: z.string().min(1, 'Corrective action required is required'),
  improvementDeadline: z.string().optional(),
  consequencesDescription: z.string().min(1, 'Consequences description is required'),
  ...
  supervisorSignatureDate: z.string().min(1, 'Supervisor signature date is required'),
