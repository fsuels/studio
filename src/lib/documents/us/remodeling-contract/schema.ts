...
export const RemodelingContractSchema = z.object({
  ...
  contractorInsuranceCoverage: z
    .string()
    .min(1, 'Insurance coverage amount is required'),
