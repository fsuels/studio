...
export const BusinessContractSchema = z.object({
  ...
  // Contract Details
  contractType: z.enum(['goods', 'services', 'partnership', 'distribution', 'consulting']),
  ...
  paymentSchedule: z.enum(['one-time', 'monthly', 'quarterly', 'annually', 'milestone-based']).optional(),
