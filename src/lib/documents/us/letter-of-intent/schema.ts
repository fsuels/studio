...
export const LetterOfIntentSchema = z.object({
  ...
  // Intent Details
  intentType: z.enum(['purchase', 'partnership', 'merger', 'joint-venture', 'licensing', 'employment', 'other']),
  ...
  // Legal Disclaimers
  bindingStatement: z.enum(['binding', 'non-binding', 'partially-binding']).default('non-binding'),
