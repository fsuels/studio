...
export const corporateBylawsSchema = z.object({
  ...
  // Shareholders
  authorizedShares: z.string().min(1, "Number of authorized shares is required"),
  shareClasses: z.string().optional(),
  shareholderMeetings: z.string().min(1, "Shareholder meeting provisions are required"),
  ...
  boardMeetingFrequency: z.string().min(1, "Board meeting frequency is required"),
  ...
  // Indemnification
  indemnificationProvisions: z.string().min(1, "Indemnification provisions are required"),
  insuranceRequirements: z.string().optional(),
  
  // Amendment Process
  bylawAmendmentProcess: z.string().min(1, "Bylaw amendment process is required"),
  votingRequirementsAmendments: z.string().min(1, "Voting requirements for amendments are required"),
  ...
  incorporatorSignature: z.string().min(1, "Incorporator signature is required"),
