...
export const websiteDevelopmentAgreementMeta: LegalDocument = {
  ...
  translations: {
    en: {
      ...
      description: 'Comprehensive agreement for website design and development services between developer and client.',
      aliases: ['web development contract', 'website design agreement', 'web services contract'],
    },
    es: {
      name: 'Acuerdo de Desarrollo de Sitio Web',
      description: 'Acuerdo integral para servicios de diseño y desarrollo de sitios web entre desarrollador y cliente.',
