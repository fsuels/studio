// src/lib/documents/us/patent-application-assignment/questions.ts
import type { Question } from '@/types/documents';

export const patentApplicationAssignmentQuestions: Question[] = [
  {
    id: 'assignorName',
    label: 'Assignor Full Name (Current Application Owner)',
    type: 'text',
    required: true,
  },
  {
  ...
  {
    id: 'assigneeName',
    label: 'Assignee Full Name (New Application Owner)',
    type: 'text',
    required: true,
  },
  {
  ...
  {
    id: 'applicationTitle',
    label: 'Patent Application Title',
    type: 'text',
    required: true,
    placeholder: 'Official title of the patent application',
  },
  {
  ...
  },
  {
    ...
    type: 'textarea',
    required: true,
    placeholder: 'Describe what the patent application covers',
  },
  {
    id: 'assignmentType',
  ...
  {
    id: 'inventorName',
    label: 'Inventor Name (if different from assignor)',
    type: 'text',
    placeholder: 'Name of the original inventor',
  },
  {
    id: 'witnessName',
