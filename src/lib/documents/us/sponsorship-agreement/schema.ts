...
export const SponsorshipAgreementSchema = z.object({
  ...
  sponsoredPartyType: z.enum(['individual', 'team', 'organization', 'event', 'venue']).default('organization'),
  
  // Sponsorship Details
  sponsorshipType: z.enum(['event', 'sports', 'media', 'venue', 'program', 'individual', 'other']).default('event'),
  sponsorshipLevel: z.enum(['title', 'presenting', 'platinum', 'gold', 'silver', 'bronze', 'supporting']).default('gold'),
  ...
  paymentSchedule: z.enum(['upfront', 'installments', 'milestone-based', 'performance-based']).default('upfront'),
  ...
  ipOwnership: z.enum(['sponsor', 'sponsored-party', 'joint', 'separate']).default('separate'),
