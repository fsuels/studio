...
export const RecordingArtistAgreementSchema = z.object({
  ...
  labelType: z
    .enum(['major', 'independent', 'boutique', 'distributor'])
    .default('independent'),

  // Contract Type
  dealType: z
    .enum(['recording', 'distribution', 'development', '360-deal', 'licensing'])
    .default('recording'),
  ...
  studioSelection: z
    .enum(['label-choice', 'artist-choice', 'mutual', 'approved-list'])
    .default('mutual'),
  producerSelection: z
    .enum(['label-choice', 'artist-choice', 'mutual', 'approved-list'])
    .default('mutual'),
  ...
  masterOwnership: z
    .enum(['label', 'artist', 'shared', 'reversion'])
    .default('label'),
  publishingRights: z
    .enum(['label', 'artist', 'shared', 'publisher'])
    .default('artist'),
  ...
  distributionTerritory: z
    .enum(['worldwide', 'north-america', 'domestic', 'international'])
    .default('worldwide'),
  ...
  // Creative Control
  artisticControl: z
    .enum(['artist', 'label', 'shared', 'approval'])
    .default('shared'),
  songSelection: z
    .enum(['artist', 'label', 'shared', 'approval'])
    .default('artist'),
  ...
  clearanceResponsibility: z
    .enum(['artist', 'label', 'shared'])
    .default('label'),
