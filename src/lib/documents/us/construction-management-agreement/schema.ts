...
export const constructionmanagementagreementSchema = z.object({
  ...
  managementPhases: z
    .array(z.enum(['pre-construction', 'construction', 'post-construction']))
    .min(1),
  ...
  serviceCommencementDate: z
    .string()
    .min(1, 'Service commencement date is required'),
  ...
  contractorSelectionMethod: z.enum([
    'owner-selects',
    'manager-recommends',
    'joint-selection',
  ]),
  ...
  generalLiabilityInsurance: z
    .string()
    .min(1, 'General liability insurance amount is required'),
  ...
  intellectualPropertyRights: z.enum([
    'owner-retains',
    'manager-retains',
    'shared',
  ]),
  ...
  // Dispute Resolution
  disputeResolutionMethod: z.enum([
    'negotiation',
    'mediation',
    'arbitration',
    'litigation',
