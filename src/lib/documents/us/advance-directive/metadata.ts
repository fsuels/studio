...
export const advanceDirectiveMeta: Omit<LegalDocument, 'schema' | 'questions'> = {
  ...
  translations: {
    en: {
      ...
      description: 'Create a comprehensive advance healthcare directive to specify your medical treatment preferences and appoint a healthcare agent.',
      aliases: [
    ...
    es: {
      ...
      description: 'Crear una directiva médica anticipada integral para especificar sus preferencias de tratamiento médico y nombrar un agente de atención médica.',
      aliases: [
