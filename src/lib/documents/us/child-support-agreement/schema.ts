...
export const ChildSupportAgreementSchema = z.object({
  ...
  // Payment Method
  paymentMethod: z.enum(['direct-payment', 'wage-garnishment', 'state-disbursement', 'automatic-transfer', 'other']),
  ...
  extracurricularResponsibility: z.enum(['obligor', 'obligee', 'shared']).optional(),
  
  // Duration and Termination
  supportDuration: z.enum(['age-18', 'age-19', 'high-school-graduation', 'college-graduation', 'specific-date', 'court-order']),
  ...
  // Tax Considerations
  taxDependencyExemption: z.enum(['obligor', 'obligee', 'alternating', 'shared']).optional(),
  ...
  attorneyFeeResponsibility: z.enum(['obligor', 'obligee', 'prevailing-party']).optional(),
