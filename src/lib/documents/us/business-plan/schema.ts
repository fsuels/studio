...
export const businessPlanSchema = z.object({
  ...
  productsServices: z
    .string()
    .min(1, 'Products/services description is required'),
  ...
  targetCustomers: z
    .string()
    .min(1, 'Target customers description is required'),
  ...
  // Operations
  businessOperations: z
    .string()
    .min(1, 'Business operations description is required'),
