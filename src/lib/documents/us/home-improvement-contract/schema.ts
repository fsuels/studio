...
export const HomeImprovementContractSchema = z.object({
  ...
  projectType: z.enum(['kitchen-remodel', 'bathroom-remodel', 'addition', 'roofing', 'flooring', 'painting', 'electrical', 'plumbing', 'hvac', 'landscaping', 'other']),
  ...
  paymentSchedule: z.enum(['upfront', 'progress-payments', 'completion', 'custom']),
  downPayment: z.string().optional(),
  progressPayments: z.array(z.object({
    milestone: z.string(),
    amount: z.string(),
  ...
  wasteDisposal: z.enum(['contractor', 'homeowner', 'shared']).default('contractor'),
  ...
  subcontractorLiability: z.enum(['contractor-responsible', 'homeowner-accepts', 'shared']).default('contractor-responsible'),
