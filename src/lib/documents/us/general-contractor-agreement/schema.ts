...
export const GeneralContractorAgreementSchema = z.object({
  ...
  // Contract Terms
  contractType: z
    .enum(['fixed-price', 'cost-plus', 'time-materials', 'unit-price'])
    .default('fixed-price'),
  ...
  // Payment Schedule
  paymentSchedule: z
    .enum(['progress', 'milestone', 'monthly', 'completion'])
    .default('progress'),
  ...
  materialSupplier: z
    .enum(['contractor', 'owner', 'allowances'])
    .default('contractor'),
