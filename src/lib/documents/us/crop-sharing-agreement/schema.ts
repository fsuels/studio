...
export const CropSharingAgreementSchema = z.object({
  ...
  sharingBasis: z
    .enum(['gross-crop', 'net-proceeds', 'fixed-bushels', 'fixed-cash'])
    .default('gross-crop'),
  marketingResponsibility: z
    .enum(['landowner', 'tenant', 'joint'])
    .default('tenant'),
