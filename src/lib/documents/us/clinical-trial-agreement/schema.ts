...
export const ClinicalTrialAgreementSchema = z.object({
  ...
  sponsorType: z.enum(['pharmaceutical', 'biotech', 'medical-device', 'academic', 'government']).optional(),
  ...
  studyPhase: z.enum(['phase-i', 'phase-ii', 'phase-iii', 'phase-iv', 'observational']).optional(),
  therapeuticArea: z.string().optional(),
  studyDesign: z.enum(['randomized', 'open-label', 'double-blind', 'placebo-controlled', 'crossover']).optional(),
  ...
  paymentSchedule: z.enum(['per-patient', 'milestone', 'quarterly', 'monthly']).default('milestone'),
  ...
  ipOwnership: z.enum(['sponsor', 'site', 'shared', 'inventor']).default('sponsor'),
