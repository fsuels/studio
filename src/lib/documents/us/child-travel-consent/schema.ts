...
export const ChildTravelConsentSchema = z.object({
  ...
  parent1Relationship: z.enum(['mother', 'father', 'guardian', 'adoptive-parent']).default('mother'),
  ...
  parent2Relationship: z.enum(['mother', 'father', 'guardian', 'adoptive-parent']).optional(),
  ...
  // Travel Information
  travelPurpose: z.enum(['vacation', 'family-visit', 'education', 'medical', 'other']).default('vacation'),
  travelDestination: z.string().optional(),
  travelDates: z.string().optional(),
  departureDate: z.string().optional(),
  returnDate: z.string().optional(),
  transportationMethod: z.enum(['airplane', 'car', 'bus', 'train', 'cruise']).default('airplane'),
  
  // Accommodation Information
  accommodationType: z.enum(['hotel', 'relative', 'friend', 'resort', 'other']).optional(),
  ...
  // Legal Custody
  custodyArrangement: z.enum(['joint', 'sole-custody', 'guardian']).default('joint'),
