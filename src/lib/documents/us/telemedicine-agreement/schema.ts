...
export const TelemedicineAgreementSchema = z.object({
  ...
  serviceType: z.enum(['consultation', 'diagnosis', 'treatment', 'follow-up', 'prescription', 'monitoring']).default('consultation'),
  serviceDescription: z.string().optional(),
  consultationType: z.enum(['video', 'phone', 'chat', 'hybrid']).default('video'),
  ...
  paymentMethod: z.enum(['insurance', 'self-pay', 'subscription', 'per-visit']).default('self-pay'),
  ...
  // Dispute Resolution
  disputeResolution: z.enum(['discussion', 'mediation', 'arbitration', 'state-board']).default('discussion'),
