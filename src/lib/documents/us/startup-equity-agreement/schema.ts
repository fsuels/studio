...
export const StartupEquityAgreementSchema = z.object({
  ...
  companyType: z.enum(['corporation', 'llc', 'partnership']).default('corporation'),
  ...
  vestingSchedule: z.enum(['4-year-cliff', '3-year-cliff', 'immediate', 'custom']).default('4-year-cliff'),
  ...
  accelerationTrigger: z.enum(['termination', 'acquisition', 'ipo', 'none']).default('none'),
  ...
  decisionMaking: z.enum(['unanimous', 'majority', 'weighted']).default('majority'),
  ...
  buyoutMechanism: z.enum(['fair-value', 'book-value', 'formula', 'appraisal']).optional(),
  ...
  financialReporting: z.enum(['monthly', 'quarterly', 'annually']).default('quarterly'),
  ...
  // Exit Strategy
  exitStrategy: z.enum(['ipo', 'acquisition', 'buyout', 'dissolution']).optional(),
