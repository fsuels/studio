...
export const NonprofitBylawsSchema = z.object({
  ...
  taxExemptStatus: z.enum(['501c3', '501c4', '501c6', '501c7', 'other']).default('501c3'),
  ...
  regularMeetingSchedule: z.enum(['monthly', 'quarterly', 'annually', 'as-needed']).default('quarterly'),
  ...
  fiscalYear: z.enum(['calendar', 'july-june', 'october-september', 'custom']).default('calendar'),
  ...
  amendmentVote: z.enum(['majority', 'two-thirds', 'three-quarters', 'unanimous']).default('two-thirds'),
  ...
  dissolutionVote: z.enum(['majority', 'two-thirds', 'three-quarters', 'unanimous']).default('two-thirds'),
