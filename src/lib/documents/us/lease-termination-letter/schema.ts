...
export const LeaseTerminationLetterSchema = z.object({
  ...
  noticeType: z.enum(['30-day', '60-day', '90-day', 'end-of-lease', 'immediate']),
  terminationReason: z.enum(['end-of-lease', 'moving', 'purchase', 'job-relocation', 'other']),
  ...
  // Security Deposit
  securityDepositAmount: z.number().min(0, 'Security deposit cannot be negative'),
