...
export const medicalConsent: LegalDocument = {
  ...
  tags: ['personal', 'low', 'legal', 'template', 'notarization'],
  translations: {
    en: {
      name: 'Child Medical Consent Form',
      description:
    ...
    es: {
      ...
      description:
        'Crea un Child Medical Consent Form legalmente válido con nuestra plantilla fácil de usar. Incluye requisitos específicos del estado.',
      aliases: [],
    },
  },
};
