...
export const ProfessionalLiabilityWaiverSchema = z.object({
  ...
  // Professional Type
  professionalType: z.enum(['doctor', 'lawyer', 'accountant', 'engineer', 'architect', 'consultant', 'therapist', 'financial-advisor', 'real-estate-agent', 'contractor', 'other']).default('consultant'),
  specialization: z.string().optional(),
  yearsOfExperience: z.string().optional(),
  
  // Client Information
  clientType: z.enum(['individual', 'business', 'organization', 'government']).default('individual'),
  ...
  standardOfCare: z.enum(['reasonable-care', 'industry-standard', 'best-efforts', 'specific-standard']).default('reasonable-care'),
  ...
  // Waiver Scope
  waiverScope: z.enum(['negligence-only', 'malpractice-only', 'all-professional-claims', 'specific-services']).default('all-professional-claims'),
  ...
  damageLimitation: z.enum(['fee-amount', 'insurance-coverage', 'specific-amount', 'no-limitation']).optional(),
