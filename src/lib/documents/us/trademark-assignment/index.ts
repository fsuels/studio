...
export const trademarkAssignment: LegalDocument = {
  ...
  translations: {
    en: {
      ...
      aliases: ['trademark assignment contract'],
    },
    es: {
      name: 'Acuerdo de Cesión de Marca',
      description:
        'Crea un Trademark Assignment Acuerdo legalmente válido con nuestra plantilla fácil de usar. Incluye requisitos específicos del estado.',
      aliases: [],
    },
  },
};
