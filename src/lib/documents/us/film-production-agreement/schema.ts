...
export const FilmProductionAgreementSchema = z.object({
  ...
  clientType: z.enum(['individual', 'studio', 'network', 'streaming', 'distributor']).optional(),
  
  // Project Details
  projectTitle: z.string().optional(),
  projectType: z.enum(['feature-film', 'short-film', 'documentary', 'commercial', 'music-video', 'series', 'pilot']).optional(),
  ...
  copyrightOwnership: z.enum(['producer', 'client', 'shared', 'distributor']).default('client'),
  ...
  finalCut: z.enum(['producer', 'director', 'client', 'distributor']).default('producer'),
