...
export const CommissionAgreementSchema = z.object({
  ...
  commissionType: z.enum(['percentage', 'flat-rate', 'tiered', 'sliding-scale']),
  ...
  salaryFrequency: z.enum(['weekly', 'bi-weekly', 'monthly', 'annually']).optional(),
  
  // Commission Calculation
  commissionBase: z.enum(['gross-sales', 'net-sales', 'gross-profit', 'net-profit']),
  ...
  // Payment Terms
  paymentFrequency: z.enum(['monthly', 'quarterly', 'upon-collection', 'upon-sale']),
