...
export const StudentLoanAgreementSchema = z.object({
  ...
  citizenship: z.enum(['us-citizen', 'permanent-resident', 'international']).default('us-citizen'),
  ...
  enrollmentStatus: z.enum(['full-time', 'part-time', 'less-than-half']).default('full-time'),
  ...
  loanPurpose: z.enum(['tuition', 'room-board', 'books', 'expenses', 'all-costs']).default('all-costs'),
  disbursementSchedule: z.enum(['semester', 'quarter', 'annual', 'single']).default('semester'),
  ...
  repaymentOptions: z.enum(['standard', 'graduated', 'extended', 'income-driven']).default('standard'),
  ...
  prepaymentApplication: z.enum(['principal', 'interest-first', 'proportional']).default('principal'),
  ...
  languagePreferences: z.enum(['english', 'spanish', 'other']).default('english'),
