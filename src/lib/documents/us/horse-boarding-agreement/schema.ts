...
export const HorseBoardingAgreementSchema = z.object({
  ...
  // Boarding Details
  boardingType: z.enum(['full-board', 'partial-board', 'pasture-board', 'training-board']).default('full-board'),
  stallType: z.enum(['box-stall', 'run-in-shed', 'pasture-only', 'paddock']).default('box-stall'),
  ...
  wateringSystem: z.enum(['automatic', 'manual', 'trough']).default('automatic'),
  ...
  dailyCare: z.enum(['full-service', 'self-care', 'partial-care']).default('full-service'),
  stallCleaning: z.enum(['daily', 'twice-daily', 'owner', 'stable']).default('daily'),
  feedingResponsibility: z.enum(['stable', 'owner', 'shared']).default('stable'),
  turnoutResponsibility: z.enum(['stable', 'owner', 'shared']).default('stable'),
