// src/lib/documents/us/release-for-use-of-likeness/schema.ts
import { z } from 'zod';

export const ReleaseforuseoflikenessSchema = z.object({
...
export type ReleaseforuseoflikenessData = z.infer<typeof ReleaseforuseoflikenessSchema>;
