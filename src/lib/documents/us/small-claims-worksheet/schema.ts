...
export const smallClaimsWorksheetSchema = z.object({
  ...
  // Case Facts
  caseFacts: z.object({
    relationshipToDefendant: z.enum([
      'customer',
      'tenant',
      'landlord',
      'contractor',
  ...
  witnesses: z
    .array(
      z.object({
        ...
        relevantKnowledge: z
          .string()
          .min(20, 'Please describe what the witness knows'),
