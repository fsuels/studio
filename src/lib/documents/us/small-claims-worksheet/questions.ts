...
export const smallClaimsWorksheetQuestions: DocumentQuestion[] = [
  ...
  },
  {
    ...
    type: 'textarea',
    required: true,
    placeholder: 'Provide a chronological, factual description of what occurred. Stick to facts, not opinions or emotions...',
    minLength: 100
  },
  {
  ...
  },
  {
    ...
    type: 'textarea',
    required: false,
    placeholder: 'Describe what the witness saw, heard, or knows about the situation',
    conditionalOn: { field: 'witnesses.0.name', value: true }
  },
  {
  ...
  // Court Preparation
  {
    ...
    type: 'textarea',
    required: false,
    placeholder: 'Brief outline of how you plan to present your case: 1) Introduce yourself, 2) Explain the agreement, 3) Show evidence...'
  },
  {
