...
export const ConfidentialityAgreementSchema = z.object({
  ...
  confidentialInfoDescription: z.string().min(1, 'Description of confidential information is required.'),
  termYears: z.coerce
    .number()
    .int()
...
export type ConfidentialityAgreementData = z.infer<typeof ConfidentialityAgreementSchema>;