...
export const TuitionAgreementSchema = z.object({
  ...
  institutionType: z
    .enum(['public', 'private', 'charter', 'religious', 'vocational', 'online'])
    .default('private'),
  ...
  financialResponsibility: z
    .enum(['student', 'parent', 'guardian', 'sponsor', 'shared'])
    .default('parent'),
  ...
  enrollmentStatus: z
    .enum(['full-time', 'part-time', 'audit'])
    .default('full-time'),
  ...
  // Payment Terms
  paymentPlan: z
    .enum(['full-payment', 'semester', 'quarterly', 'monthly', 'custom'])
    .default('semester'),
  ...
  statementDelivery: z
    .enum(['mail', 'email', 'online-portal'])
    .default('email'),
  communicationPreference: z
    .enum(['email', 'phone', 'mail', 'text'])
    .default('email'),
