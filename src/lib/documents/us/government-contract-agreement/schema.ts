...
export const GovernmentContractAgreementSchema = z.object({
  ...
  agencyLevel: z.enum(['federal', 'state', 'county', 'municipal']).default('federal'),
  ...
  contractType: z.enum(['fixed-price', 'cost-reimbursement', 'time-materials', 'indefinite-delivery']).optional(),
  ...
  procurementMethod: z.enum(['sealed-bid', 'competitive-proposal', 'sole-source', 'small-business-set-aside']).optional(),
  naicsCode: z.string().optional(),
  pscCode: z.string().optional(),
  competitionType: z.enum(['full-open', 'set-aside', 'sole-source', 'limited']).optional(),
  ...
  clearanceLevel: z.enum(['confidential', 'secret', 'top-secret', 'none']).default('none'),
  ...
  // Payment Terms
  paymentSchedule: z.enum(['monthly', 'milestone', 'completion', 'progress']).default('monthly'),
  ...
  dataRights: z.enum(['unlimited', 'limited', 'restricted', 'government-purpose']).default('limited'),
  ...
  // Dispute Resolution
  disputeResolution: z.enum(['contracting-officer', 'appeals-board', 'court-claims']).default('contracting-officer'),
