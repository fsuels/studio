...
export const mechanicslienwaiverMeta: LegalDocument = {
  ...
  translations: {
    en: {
      ...
      description: 'Legal waiver releasing mechanics lien rights upon payment for construction work or materials.',
      aliases: ['lien waiver', 'lien release', 'waiver of lien rights'],
    },
    es: {
      name: 'Renuncia de Gravamen de Mecánicos',
      description: 'Renuncia legal que libera los derechos de gravamen de mecánicos al recibir el pago por trabajo de construcción o materiales.',
