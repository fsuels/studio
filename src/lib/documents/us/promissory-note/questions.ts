...
export const promissoryNoteQuestions = [
  ...
  { id: 'lenderAddress',    label: 'Lender Address',         type: 'text',    required: true, placeholder: 'Street, City, State, ZIP' },
  { id: 'borrowerName',     label: 'Borrower Name',          type: 'text',    required: true },
  { id: 'borrowerAddress',  label: 'Borrower Address',       type: 'text',    required: true, placeholder: 'Street, City, State, ZIP' },
  { id: 'principalAmount',  label: 'Principal Amount',       type: 'number',  required: true, placeholder: 'e.g., 10000' },
  { id: 'interestRate',     label: 'Interest Rate (%)',      type: 'number',  required: true, placeholder: 'e.g., 5' },
  {
    id: 'paymentFrequency',
