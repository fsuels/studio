...
export const InventionAssignmentAgreementSchema = z.object({
  ...
  assignmentScope: z.enum(['all', 'work-related', 'specific'], { errorMap: () => ({ message: 'Assignment scope is required.' }) }),
...
export type InventionAssignmentAgreementData = z.infer<typeof InventionAssignmentAgreementSchema>;