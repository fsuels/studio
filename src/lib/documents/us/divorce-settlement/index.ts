...
export const divorceSettlement: LegalDocument = {
  ...
  tags: ['personal', 'high', 'legal', 'template', 'notarization'],
  translations: {
    en: {
      name: 'Divorce Settlement Agreement',
      description:
        'Create a legally binding Divorce Settlement Agreement with our easy-to-use template. State-specific requirements included.',
      aliases: ['divorce settlement contract'],
    },
    es: {
      name: 'Acuerdo de Divorcio',
      description:
        'Crea un Divorce Settlement Acuerdo legalmente válido con nuestra plantilla fácil de usar. Incluye requisitos específicos del estado.',
      aliases: [],
    },
  },
};
