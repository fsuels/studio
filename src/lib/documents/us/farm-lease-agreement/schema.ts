...
export const FarmLeaseAgreementSchema = z.object({
  ...
  tenantType: z
    .enum(['individual', 'corporation', 'partnership', 'family-farm'])
    .default('individual'),
  ...
  // Rent and Payments
  leaseType: z
    .enum(['cash-rent', 'crop-share', 'cash-plus-crop', 'flexible-cash'])
    .default('cash-rent'),
  ...
  paymentSchedule: z
    .enum(['annual', 'semi-annual', 'quarterly', 'harvest'])
    .default('annual'),
  ...
  cropTypes: z
    ...
    .default(['corn']),
  livestockTypes: z
    .array(z.enum(['cattle', 'pigs', 'sheep', 'goats', 'chickens', 'horses']))
    .optional(),
  ...
  decisionMaking: z
    .enum(['tenant', 'consultation', 'joint'])
