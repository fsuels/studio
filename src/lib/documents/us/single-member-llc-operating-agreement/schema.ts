...
export const singleMemberLlcOperatingAgreementSchema = z.object({
  ...
  principalPlaceOfBusiness: z
    .string()
    .min(1, 'Principal place of business is required'),
  ...
  initialCapitalContribution: z
    .string()
    .min(1, 'Initial capital contribution is required'),

  // Management Structure
  managementStructure: z
    .enum(['member-managed', 'manager-managed'])
