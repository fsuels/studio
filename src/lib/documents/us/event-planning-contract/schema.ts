...
export const EventPlanningContractSchema = z.object({
  ...
  // Event Details
  eventType: z.enum(['wedding', 'birthday', 'corporate', 'anniversary', 'graduation', 'other']).default('wedding'),
  ...
  feeStructure: z.enum(['flat-fee', 'hourly', 'percentage', 'package']).default('flat-fee'),
  hourlyRate: z.string().optional(),
  percentageOfBudget: z.string().optional(),
  
  // Payment Terms
  paymentSchedule: z.enum(['full-upfront', 'deposit-balance', 'installments']).default('deposit-balance'),
  ...
  vendorPaymentResponsibility: z.enum(['client', 'planner', 'shared']).default('client'),
  ...
  vendorChangeResponsibility: z.enum(['client', 'planner', 'shared']).default('client'),
  ...
  eventDesignOwnership: z.enum(['planner', 'client', 'shared']).default('shared'),
