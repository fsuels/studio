...
export const ContractAmendmentSchema = z.object({
  ...
  originalContractTitle: z.string().min(1, "Original contract title is required"),
  originalContractDate: z.string().min(1, "Original contract date is required"),
  originalContractParties: z.string().min(1, "Original contract parties are required"),
  ...
  amendmentEffectiveDate: z.string().min(1, "Amendment effective date is required"),
  ...
  sectionsAmended: z.string().min(1, "Sections being amended must be specified"),
  ...
  partyOneAuthorizedRepresentative: z.string().min(1, "Party one representative is required"),
  partyOneTitle: z.string().optional(),
  partyTwoAuthorizedRepresentative: z.string().min(1, "Party two representative is required"),
