...
export const consignmentAgreement: LegalDocument = {
  ...
  translations: {
    en: {
      ...
      aliases: ['consignment contract'],
    },
    es: {
      name: 'Consignment Acuerdo',
      description:
        'Crea un Consignment Acuerdo legalmente válido con nuestra plantilla fácil de usar. Incluye requisitos específicos del estado.',
      aliases: [],
    },
  },
};
