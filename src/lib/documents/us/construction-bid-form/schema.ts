...
export const constructionbidformSchema = z.object({
  ...
  // Alternate Bid Items
  alternateBids: z.array(z.object({
  ...
  bidBondType: z.enum(['surety-bond', 'certified-check', 'cashiers-check', 'bid-bond']).optional(),
  ...
  bankingReferences: z.array(z.object({
    bankName: z.string(),
  ...
  majorMaterialSuppliers: z.array(z.object({
    material: z.string(),
