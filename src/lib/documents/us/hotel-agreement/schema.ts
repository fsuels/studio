...
export const HotelAgreementSchema = z.object({
  ...
  operationsManagement: z
    .enum(['joint', 'primary-party', 'secondary-party', 'hired-manager'])
    .default('joint'),
  frontDeskManagement: z
    .enum(['joint', 'primary-party', 'secondary-party', 'hired-manager'])
    .default('joint'),
  housekeepingManagement: z
    .enum(['joint', 'primary-party', 'secondary-party', 'hired-manager'])
    .default('joint'),
  maintenanceManagement: z
    .enum(['joint', 'primary-party', 'secondary-party', 'hired-manager'])
    .default('joint'),
  ...
  cancellationPolicy: z
    ...
    .default('moderate'),
  petPolicy: z
    .enum(['no-pets', 'pets-allowed', 'pets-with-fee'])
    .default('no-pets'),
  smokingPolicy: z
    .enum(['no-smoking', 'smoking-rooms-available', 'designated-areas'])
    .default('no-smoking'),
