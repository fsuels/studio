...
export const SportsAgreementSchema = z.object({
  ...
  // Agreement Type
  agreementType: z.enum(['player-contract', 'coaching', 'training', 'facility-use', 'sponsorship']).default('player-contract'),
  serviceDescription: z.string().optional(),
  participationLevel: z.enum(['recreational', 'competitive', 'professional']).default('recreational'),
  ...
  // Financial Terms
  compensationType: z.enum(['none', 'salary', 'stipend', 'prize-money', 'scholarships']).default('none'),
  compensationAmount: z.string().optional(),
  paymentSchedule: z.enum(['weekly', 'monthly', 'seasonal', 'per-game']).optional(),
