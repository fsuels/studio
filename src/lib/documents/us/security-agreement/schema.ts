...
export const SecurityAgreementSchema = z.object({
  ...
  securedDebtDescription: z
    .string()
    .min(1, 'Description of secured debt is required'),
  ...
  collateralDescription: z
    .string()
    .min(1, 'Collateral description is required'),
