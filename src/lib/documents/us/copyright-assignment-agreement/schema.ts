...
export const CopyrightAssignmentAgreementSchema = z.object({
  ...
  assignorType: z.enum(['individual', 'corporation', 'partnership', 'llc', 'other']),
  ...
  assigneeType: z.enum(['individual', 'corporation', 'partnership', 'llc', 'other']),
  ...
  workType: z.enum(['literary', 'musical', 'dramatic', 'choreographic', 'pictorial', 'graphic', 'sculptural', 'motion-picture', 'sound-recording', 'architectural', 'software', 'other']),
  ...
  // Assignment Scope
  assignmentType: z.enum(['complete', 'partial', 'exclusive-license', 'non-exclusive-license']),
  ...
  // Term and Duration
  assignmentTerm: z.enum(['perpetual', 'life-plus-70', 'specific-years', 'specific-date']),
  specificYears: z.string().optional(),
  terminationDate: z.string().optional(),
  
  // Consideration
  hasConsideration: z.boolean().default(true),
  considerationType: z.enum(['monetary', 'royalty', 'other-works', 'services', 'other']).optional(),
  ...
  recordingResponsibility: z.enum(['assignor', 'assignee', 'both']).default('assignee'),
