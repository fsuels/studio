...
export const MiningLeaseAgreementSchema = z.object({
  ...
  lessorType: z.enum(['individual', 'corporation', 'government', 'trust']).default('individual'),
  ...
  lesseeType: z.enum(['individual', 'corporation', 'partnership', 'llc']).default('corporation'),
  ...
  // Mineral Rights
  mineralTypes: z.array(z.enum(['coal', 'oil', 'gas', 'gold', 'silver', 'copper', 'iron', 'limestone', 'gravel', 'sand', 'other'])).default(['coal']),
  ...
  royaltyCalculationMethod: z.enum(['gross-value', 'net-value', 'posted-price']).default('gross-value'),
  ...
  productionReports: z.enum(['monthly', 'quarterly', 'annually']).default('quarterly'),
