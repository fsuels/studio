...
export function enhanceContentWithLinks(
  ...
  filteredSuggestions.forEach(suggestion => {
    ...
    if (keywordRegex.test(enhancedContent)) {
      ...
      const linkClass = "internal-doc-link text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 underline font-medium";
 ...
 */
export function generateContextualCTA(content: string, locale: 'en' | 'es' = 'en'): {
  title: string;
  description: string;
  buttonText: string;
  linkUrl: string;
  ...
  const ctaTexts = {
    en: {
      ...
      description: `Use our professionally drafted template to get started today. Fully customizable and legally compliant.`,
    ...
    es: {
      ...
      description: `Usa nuestra plantilla redactada profesionalmente para comenzar hoy. Completamente personalizable y legalmente compatible.`,
