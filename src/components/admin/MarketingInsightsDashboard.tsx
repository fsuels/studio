      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            UTM attribution, campaign ROI, and discount code performance
            analytics
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <Select
            ...
            onValueChange={setSelectedAttribution}
          >
        ...
        <TabsContent value="attribution" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {Object.entries(data.attribution.modelComparison).map(
                    ([model, metrics]) => (
                      <div
                        key={model}
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {data.attribution.conversionPaths
                    .slice(0, 5)
                    .map((path, index) => (
                      <div
                        key={index}
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {data.attribution.topPerformingChannels.map(
                  (channel, index) => (
                    <div
                      key={index}
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold mt-2">
                  {data.discounts.totalCodesActive}
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold mt-2">
                  ${data.discounts.totalRevenueWithDiscounts.toLocaleString()}
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-2xl font-bold mt-2">
                  ${data.discounts.incrementalRevenue.toLocaleString()}
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-lg font-bold">
              {channel.efficiency.roas.toFixed(2)}x
            </p>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">Revenue</p>
            <p className="text-lg font-bold">
              ${channel.performance.revenue.toLocaleString()}
            </p>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">CPA</p>
            <p className="text-sm font-medium">
              ${channel.efficiency.cpa.toFixed(2)}
            </p>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">Conversions</p>
            <p className="text-sm font-medium">
              {channel.performance.conversions}
            </p>
          </div>
        </div>
...
function CampaignCard({ campaign }: { campaign: CampaignPerformance }) {
  const progressPercent =
    (campaign.budget.spent / campaign.budget.allocated) * 100;
      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
          <div>
            <p className="text-xs text-muted-foreground">ROAS</p>
            <p className="text-lg font-bold">
              {campaign.revenue.roas.toFixed(2)}x
            </p>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">Revenue</p>
            <p className="text-lg font-bold">
              ${campaign.revenue.total.toLocaleString()}
            </p>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">Conversions</p>
          ...
          <div>
            ...
            <p className="text-lg font-bold">
              {(campaign.conversions.conversionRate * 100).toFixed(1)}%
            </p>
          </div>
        </div>
      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div>
            <p className="text-xs text-muted-foreground">Revenue</p>
            <p className="text-lg font-bold">
              ${discount.performance.revenueGenerated.toLocaleString()}
            </p>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">Incremental</p>
            <p className="text-lg font-bold">
              ${discount.performance.incrementalRevenue.toLocaleString()}
            </p>
          </div>
          <div>
            <p className="text-xs text-muted-foreground">New Customers</p>
            <p className="text-lg font-bold">
              {(discount.customerBehavior.newCustomerRate * 100).toFixed(0)}%
            </p>
          </div>
        </div>
      </CardContent>
      ...
      topPerformingCodes: [
        {
          ...
          attribution: {
            acquisitionChannel: { google_ads: 140, facebook: 65, organic: 40 },
            customerSegment: { new: 220, returning: 25 },
            documentTypes: { llc: 89, lease: 76, nda: 80 },
          },
          timing: {
            createdAt: '2024-01-01T00:00:00Z',
