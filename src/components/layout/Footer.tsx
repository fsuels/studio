  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    if (!email.includes('@')) {
      toast({
        ...
        description: t('errorInvalidEmailDesc', { defaultValue: 'Please enter a valid email address.' }),
        variant: 'destructive',
      });
      return;
    }
    ...
    toast({
      ...
      description: t('subscribedSuccessDesc', { defaultValue: 'Thanks for joining our mailing list.' }),
    });
    setEmail('');
    setIsLoading(false);
  };
  ...
  const footerLinkSections = [
    {
      ...
      links: [
        { path: '/#workflow-start', labelKey: 'linkHowItWorks', defaultLabel: 'How It Works' },
        { path: '/pricing',       labelKey: 'linkPricing',    defaultLabel: 'Pricing' },
        { path: '/features',      labelKey: 'linkFeatures',   defaultLabel: 'Features' },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        { path: '/privacy-policy',    labelKey: 'linkPrivacyPolicy',  defaultLabel: 'Privacy Policy' },
        { path: '/terms-of-service',  labelKey: 'linkTermsOfService', defaultLabel: 'Terms of Service' },
        { path: '/disclaimer',        labelKey: 'linkDisclaimer',     defaultLabel: 'Disclaimer' },
      ],
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs">
              {t('subhead', { defaultValue: 'AI-Powered Legal Document Generation. Fast, Affordable, Secure.'})}
            </p>
          </div>
          ...
          <div>
            <h3 className="font-semibold text-foreground mb-3">
              {t('sectionCommunityTitle', {defaultValue: "Community & Contact"})}
            </h3>
            <div className="flex space-x-3 mb-4">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"
                 aria-label={t('socialLinkedInAria', {defaultValue: "LinkedIn Page"})}
                 className="text-muted-foreground hover:text-primary transition-colors">
                <Linkedin className="h-5 w-5" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer"
                 aria-label={t('socialTwitterAria', {defaultValue: "Twitter Profile"})}
                 className="text-muted-foreground hover:text-primary transition-colors">
            ...
            <div className="text-xs space-y-1 mb-6">
              <p className="flex items-center gap-1.5">
                ...
                <span>{t('supportPhoneNumber', {defaultValue: "+1 (800) 555-0199 (Support)"})}</span>
              </p>
              <p className="flex items-center gap-1.5">
            ...
            <p className="text-xs mt-2">
              {t('joinMailingListDesc', {defaultValue: "Join our mailing list for exclusive offers."})}
            </p>
          </div>
        </div>
