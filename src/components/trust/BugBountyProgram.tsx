...
const vulnerabilityTypes: VulnerabilityType[] = [
  ...
  },
  {
    severity: 'High',
    description:
      'Privilege escalation, sensitive data exposure, XSS with impact',
    reward: '$500 - $2,000',
    color: 'orange',
    examples: [
      ...
      <CardContent className="space-y-6">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <div className="text-lg font-bold text-green-600">
                {programStats.vulnerabilitiesFixed}
              </div>
            </div>
            <div className="text-xs text-muted-foreground">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-1 mb-1">
              ...
              <div className="text-lg font-bold text-orange-600">
                {programStats.averageResponseTime}
              </div>
            </div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">
                We provide legal safe harbor for security research conducted
                under this program. Good faith testing will not result in legal
                action, provided you follow our guidelines and do not violate
                applicable laws.
              </p>
            </div>
          </div>
        ...
        <div className="border rounded-lg p-4">
          ...
          <p className="text-sm text-muted-foreground mb-3">
            We recognize and thank security researchers who help make
            123LegalDoc more secure:
          </p>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <p className="text-sm text-yellow-800">
                <strong>Important:</strong> Testing must be conducted against
                your own accounts or with explicit permission. Unauthorized
                access to user accounts or data is prohibited and may result in
                legal action.
              </p>
            </div>
          </div>
