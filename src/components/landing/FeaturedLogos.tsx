...
const logos = [
  { src: "/images/logos/forbes-logo.svg", alt: "Forbes", dataAiHint: "Forbes logo" },
  { src: "/images/logos/nyt-logo.svg", alt: "New York Times", dataAiHint: "New York Times logo"},
  { src: "/images/logos/techcrunch-logo.svg", alt: "TechCrunch", dataAiHint: "TechCrunch logo" },
  { src: "/images/logos/univision-logo.svg", alt: "Univision", dataAiHint: "Univision logo" },
  { src: "/images/logos/bloomberg-logo.svg", alt: "Bloomberg", dataAiHint: "Bloomberg logo" },
];
    ...
    <section className="bg-secondary/30 py-12 md:py-16 text-center">
      <div className="container mx-auto px-4">
        <p className="uppercase text-muted-foreground tracking-wider mb-8 text-sm font-semibold">
          {isHydrated ? t('home.featuredIn', {defaultValue: "FEATURED IN"}) : placeholderText}
        </p>
