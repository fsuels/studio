    ...
    >
      ...
      >
        <rect
          ...
          height="26"
          rx="3"
          stroke="#008080" // Original Teal
          strokeWidth="1.5"
          fill="#D1E9FF" // Original Soft Blue
        />
        <path
          d="M19 3L19 9L28 9" // Adjusted fold based on typical document icons
          stroke="#006666" // Darker Teal for fold shadow
          strokeWidth="1.5"
          fill="#AED7FF" // Slightly darker blue for fold
          strokeLinejoin="round"
        />
        <line
          x1="8"
          y1="13" // Adjusted line positions
          x2="24"
          y2="13"
          stroke="#008080" 
          strokeWidth="1.5"
      ...
      <span
        ...
        style={{ color: '#008080' }} // Original Teal for text
      >
