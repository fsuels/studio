...
import { BaseComponentProps, ClassNameHelpers, AccessibilityHelpers, setDisplayName } from '@/lib/component-standards';
...
export const Stars = React.memo<StarsProps>(function Stars({
  ...
  return (
    <div 
      ...
      {...rest}
    >
      {starsArray.map(({ id: starId, index, isFilled, isHalfFilled, value }) => (
        <Star
          key={starId}
