...
const mockUseVinDecoder = useVinDecoder as jest.MockedFunction<typeof useVinDecoder>
...
describe('FieldRenderer', () => {
  ...
  it('renders email input field with tooltip', () => {
    ...
    expect(screen.getByRole('button', { name: /Info for Email Address/ })).toBeInTheDocument()
  })
  ...
  it('handles VIN field with decoder', async () => {
    ...
    mockUseVinDecoder.mockReturnValue({
      decode: mockDecode,
      data: { year: '2020', make: 'Toyota', model: 'Camry', bodyClass: 'Sedan' },
      loading: false,
      error: null,
    })
    ...
    expect(screen.getByText(/Decoded: 2020 Toyota Camry \(Sedan\)/)).toBeInTheDocument()
  })
  ...
  it('handles notarization toggle when required by state', () => {
    ...
    expect(screen.getByText(/Notarization \(Required by State\)/)).toBeInTheDocument()
  })
  ...
  it('shows warranty text field when not sold as-is', () => {
    ...
    expect(screen.getByPlaceholderText(/Describe warranty/)).toBeInTheDocument()
  })
  ...
  it('hides warranty text field when sold as-is', () => {
    ...
    expect(screen.queryByPlaceholderText(/Describe warranty/)).not.toBeInTheDocument()
  })
