...
describe('AddressField', () => {
  ...
  it('handles place selection and extracts address components', async () => {
    ...
    const hiddenInput = screen.getByDisplayValue('123 Main St, San Francisco, CA 94102')
  ...
  it('applies custom className', () => {
    ...
    expect(container.querySelector('.custom-address-field')).toBeInTheDocument()
  })
  ...
  it('handles null place value', async () => {
    ...
    const hiddenInput = document.querySelector(`input[id="${defaultProps.name}"]`)
